...
delete_option( 'alorbach_default_chat_model' );
delete_option( 'alorbach_default_max_tokens' );
delete_option( 'alorbach_max_tokens_options' );
delete_option( 'alorbach_default_image_size' );
delete_option( 'alorbach_default_audio_model' );
delete_option( 'alorbach_default_video_model' );
delete_option( 'alorbach_general_defaults_migrated' );
...
delete_option( 'alorbach_billing_url_subscribe' );
delete_option( 'alorbach_billing_url_top_up' );
delete_option( 'alorbach_billing_url_manage_account' );
delete_option( 'alorbach_billing_url_account_overview' );
