...
class Admin_Menu {
	...
	public static function register() {
		...
		add_submenu_page( 'alorbach-ai-gateway', __( 'Queue', 'alorbach-ai-gateway' ), __( 'Queue', 'alorbach-ai-gateway' ), 'manage_options', 'alorbach-image-queue', array( Admin_Image_Queue::class, 'render' ) );
