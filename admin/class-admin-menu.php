...
class Admin_Menu {
	...
	public static function register() {
		...
		add_submenu_page( 'alorbach-ai-gateway', __( 'User Plans', 'alorbach-ai-gateway' ), __( 'User Plans', 'alorbach-ai-gateway' ), 'manage_options', 'alorbach-user-plans', array( Admin_User_Plans::class, 'render' ) );
		...
		add_submenu_page( 'alorbach-ai-gateway', __( 'Image Queue', 'alorbach-ai-gateway' ), __( 'Image Queue', 'alorbach-ai-gateway' ), 'manage_options', 'alorbach-image-queue', array( Admin_Image_Queue::class, 'render' ) );
